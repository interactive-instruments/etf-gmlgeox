...
This fork of the ETF component [etf-gmlgeox](https://github.com/etf-validator/etf-gmlgeox) is used by interactive instruments to implement and test new features before they are merged back into the master branch.
